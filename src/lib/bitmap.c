 ...
 */
#include <bitmap.h>
int64_t bitmap_find_nth(bitmap_t map, size_t size, size_t nth, size_t start, bool set) {
...
uint64_t bitmap_find_consec(bitmap_t map, size_t size, size_t start, size_t n, bool set) {
    uint64_t count = 0;
    int64_t  i = 0;
    // find first set
